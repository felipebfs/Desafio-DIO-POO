...
Este desafio foi realizado através da plataforma de cursos online <strong>DIO</a></strong>.

O principal objetivo foi colocar em prática ferramentas da Orientação a Objeto: <strong>ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO,</strong> através de um projeto Java. </p>
